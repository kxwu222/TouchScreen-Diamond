      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center px-12 py-24">
        <div className="w-full px-8 max-w-4xl flex flex-col h-full">
          ...
          <div className="flex-shrink-0 mb-8 flex justify-center">
            <button className="w-full max-w-3xl bg-[#23125E] text-white py-16 px-10 rounded-3xl text-4xl font-bold text-center font-source-serif-pro shadow-2xl">
          ...
          {/* Secondary Buttons */}
          <div className="flex-shrink-0 mb-8 flex justify-center">
              <button onClick={() => navigate('/university-talks')} className="w-full max-w-3xl bg-[#7000FF] text-white py-16 px-10 rounded-3xl text-4xl text-center font-bold font-source-serif-pro shadow-2xl">
                University talks
              </button>
          </div>
          ...
          <div className="flex-shrink-0 mb-8 flex justify-center">
            <div className="w-full max-w-3xl bg-gradient-to-br from-black/20 to-black/20 backdrop-blur-lg border-2 border-white/20 rounded-3xl py-16 px-12 shadow-2xl cursor-pointer">
              <div className="flex items-center justify-center space-x-4">
                <h2 className="text-white text-4xl font-bold font-source-serif-pro drop-shadow-lg transition-colors duration-300">
                  Your open day guide
                </h2>
              </div>
            </div>
          ...
          <div className="flex-shrink-0 mb-20 flex justify-center">
            <div 
              ...
              className="w-full max-w-3xl bg-gradient-to-r from-black/20 to-black/20 backdrop-blur-lg border border-white/20 rounded-3xl p-12 cursor-pointer transition-all duration-300 shadow-2xl"
            >
              <div className="flex justify-between items-center">
                <div className="flex-1">
                  <div className="flex items-center space-x-4 mb-3">
                    {/* TikTok-style icon */}
                    <div className="bg-black/20 border-2 border-white/20 rounded-full p-3 transition-all duration-300">
                      <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                      </svg>
                    </div>
                    <h3 className="text-white text-4xl font-bold font-source-serif-pro drop-shadow-lg transition-colors duration-300 tracking-wider">
                      Student TikTok Videos
                    </h3>
                  </div>
                  <p className="text-gray-300 text-2xl ml-16">Watch student life highlights and experiences</p>
                </div>
                <div className="bg-white/20 backdrop-blur-sm border border-white/30 rounded-full p-6 transition-all duration-300">
                  <ArrowUpRight className="text-white w-10 h-10 transition-transform duration-300" />
                </div>
              </div>
            </div>
          </div>
